...
const ACTIVATION_TIME = new Date("2026-03-05T19:50:00Z").getTime(); // TEST: 20:50 CET today
...
const SEED_POSITIONS: Record<string, { lat: number; lon: number; timestamp: string }> = {
  "863738070365391": { lat: 46.173556, lon: 13.740111, timestamp: "2026-03-05T19:50:00Z" }, // Medusa  (46°10'24.8"N 13°44'24.4"E)
  "863738070405031": { lat: 46.173500, lon: 13.740139, timestamp: "2026-03-05T19:50:00Z" }, // Proxima (46°10'24.6"N 13°44'24.5"E)
};
